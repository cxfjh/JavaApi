...
public class Gui {
    ...
    /**
     * 初始化JavaFX WebView，并加载网页
     * 
     * @param jfxPanel 要嵌入WebView的JFXPanel
     * @param url 要加载的网页地址
     */
    private static void initFX(final JFXPanel jfxPanel, final String url) {
        final WebView webView = new WebView();
        final WebEngine webEngine = webView.getEngine();
        webEngine.load(url);
        
        // 设置WebView属性 (比如支持JavaScript)
        webEngine.setJavaScriptEnabled(true);

        // 创建JavaFX场景并添加到Swing的JFXPanel中
